...
[![](figures/R.png){fig-align="center" width="498"}](https://www.r-project.org/)

## Leaflet

インタラクティブ地図を作成できるJavaScriptライブラリ

[![](figures/Leaflet.png){fig-align="center" width="498"}](https://leafletjs.com/)
...
![](figures/Shiny.png){fig-align="center" width="498"}

## データ

-   [いしかわオープンデータカタログ](https://ishikawa-datapf.jp/odp/)から

    -   [石川県クマ出没データ](https://ishikawa-datapf.jp/ckan/dataset/bear_incidents_data)

-   [国土数値情報](https://nlftp.mlit.go.jp/ksj/)から

    -   [行政区域データ](https://nlftp.mlit.go.jp/ksj/gml/datalist/KsjTmplt-N03-v3_0.html)
    -   [土地利用3次メッシュデータ](https://nlftp.mlit.go.jp/ksj/gml/datalist/KsjTmplt-L03-a.html)
...
具体的な内容 ☞ [石川県のクマ出没データをRで前処理](https://ito4303.sakura.ne.jp/posts/2025-07-16-kuma-preprocess/)
